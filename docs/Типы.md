...
Информация, отправленная функции с декоратором `on_bot_start`.
...
Информация, отправленная функции с декоратором `on_command`.
...
- `args_raw: str` - сырые, неразделённые пробелами аргументы команды. Полезно, если нужно обрабатывать аргументы команды, которые содержат пробелы. Также представлены как `CommandContext.content`
...
Информация, отправленная функции с декоратором `on_button_callback`.
...
Информация, отправленная функции с декоратором `on_button_chat_create`.
...
Информация, отправляемая функции с декоратором `on_message_delete`.
...
### `MessageDeletePayload.send(text: str | None, format: Literal['html', 'markdown', 'default'] | None = 'default', notify: bool = True, disable_link_preview: bool = False, keyboard: List[List[buttons.Button]] | buttons.KeyboardBuilder | None = None, attachments: List[Attachment] | Attachment | None = None) -> Message`

Отправляет сообщение в чат, в котором было удалено сообщение.
...
Информация, отправляемая функции с декоратором `on_message_edit`.

Декоратор вызывается при изменении сообщения.

- `timestamp: int` - время удаления сообщения

- `before: Message | None` - сообщение до изменения, найденое в кэше бота. Если кэширование сообщений выключено или сообщение не находится в кэше, то это будет `None`

- `after: Message` - новое, измененное сообщение

### `MessageEditPayload.send(text: str | None, format: Literal['html', 'markdown', 'default'] | None = 'default', notify: bool = True, disable_link_preview: bool = False, keyboard: List[List[buttons.Button]] | buttons.KeyboardBuilder | None = None, attachments: List[Attachment] | Attachment | None = None) -> Message`

Отправляет сообщение в чат, в котором было изменено сообщение.
...
### `MessageEditPayload.reply(text: str | None, format: Literal['html', 'markdown', 'default'] | None = 'default', notify: bool = True, disable_link_preview: bool = False, keyboard: List[List[buttons.Button]] | buttons.KeyboardBuilder | None = None, attachments: List[Attachment] | Attachment | None = None) -> Message`

Отвечает на измененное сообщение.
...
Информация, отправляемая функции с декоратором `on_chat_title_change`.
...
### `ChatTitleEditPayload.send(text: str | None, format: Literal['html', 'markdown', 'default'] | None = 'default', notify: bool = True, disable_link_preview: bool = False, keyboard: List[List[buttons.Button]] | buttons.KeyboardBuilder | None = None, attachments: List[Attachment] | Attachment | None = None) -> Message`

Отправляет сообщение в чат с измененным названием.
...
Информация, отправляемая функции с декоратором `on_bot_add` или `on_bot_remove`.
...
### `ChatMembershipPayload.send(text: str | None, format: Literal['html', 'markdown', 'default'] | None = 'default', notify: bool = True, disable_link_preview: bool = False, keyboard: List[List[buttons.Button]] | buttons.KeyboardBuilder | None = None, attachments: List[Attachment] | Attachment | None = None) -> Message`

Отправляет сообщение в чат, в которого добавили бота.

Поднимет ошибку, если бот вышел из чата.
...
Информация, отправляемая функции с декоратором `on_user_add` или `on_user_remove`.
...
### `UserMembershipPayload.send(text: str | None, format: Literal['html', 'markdown', 'default'] | None = 'default', notify: bool = True, disable_link_preview: bool = False, keyboard: List[List[buttons.Button]] | buttons.KeyboardBuilder | None = None, attachments: List[Attachment] | Attachment | None = None) -> Message`

Отправляет сообщение в чат, в который зашел или из которого вышел пользователь.
...
Информация, отправленная функции с декоратором `on_exception`.

Декоратор вызывается при поднятии исключения в любом хендлере, кроме `on_exception`.

- `exception: Exception` - объект класса `Exception`, из-за которого вызвался хендлер

- `obj: any` - объект, переданный хендлеру, в котором возникло исключение (например, сообщение, контекст или другая полезная нагрузка)

- `sendable: bool` - будут ли функции `ExceptionContext.send` или `ExceptionContext.reply` что-либо делать

### `ExceptionContext.send(text: str | None, format: Literal['html', 'markdown', 'default'] | None = 'default', notify: bool = True, disable_link_preview: bool = False, keyboard: List[List[buttons.Button]] | buttons.KeyboardBuilder | None = None, attachments: List[Attachment] | Attachment | None = None) -> Message`

Является функцией `send` у `obj`. Если у `obj` таковой нет, функция ничего не делает.
...
### `ExceptionContext.reply(text: str | None, format: Literal['html', 'markdown', 'default'] | None = 'default', notify: bool = True, disable_link_preview: bool = False, keyboard: List[List[buttons.Button]] | buttons.KeyboardBuilder | None = None, attachments: List[Attachment] | Attachment | None = None) -> Message`

Является функцией `reply` у `obj`. Если у `obj` таковой нет, но есть функция `send`, будет вызвана она. В другом случае функция ничего не делает.
