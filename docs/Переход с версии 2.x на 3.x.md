...
- Появилась поддержка фильтров декораторам:
  - [`on_command`](Декораторы#on_commandname-str--none--none-filters-aliases-liststr---description-str--none--none-as_message-bool--false)
  - [`on_bot_start`](Декораторы#on_bot_start)
  - [`on_chat_title_change`](Декораторы#on_chat_title_change)
